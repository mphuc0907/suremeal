...
$myrows = $wpdb->get_row( "SELECT * FROM tt_vouchers WHERE id=".$id );
                            ...
                            <table class="form-table ft_metabox leftform">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="validate-input" id="ten_chuong_trinh"
                                               name="ten_chuong_trinh" value="<?= $myrows->ten_chuong_trinh ?>" size="50" placeholder="Nhập vào">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="validate-input" id="ma_voucher" name="ma_voucher"
                                               value="<?= $myrows->ma_voucher ?>" size="50" placeholder="Nhập vào" readonly>
                                        ...
                                        <div class="loaigiamgia">
                                            <div class="type-gg">
                                                <select name="" id="loai_giam_gia">
                                                    <option <?= $myrows->loai_giam_gia == 1?'selected':'' ?> value="1">Theo số tiền</option>
                                                    <option <?= $myrows->loai_giam_gia == 2?'selected':'' ?> value="2">Theo phần trăm</option>
                                                </select>
                                            </div>
                                            <div class="price-gg">
                                                <div class="type-input type-1">
                                                    <input type="number" class="" id="muc_giam" value="<?= $myrows->muc_giam ?>"
                                                           placeholder="Nhập vào">
                                                    <label id="muc_giam-error" class="error d-none" for="muc_giam">Không
                                                        được để trống ô</label>
                                                </div>
                                                <div class="type-input type-2 d-none">
                                                    <input type="number" class="" id="muc_giam_2" value="<?= $myrows->muc_giam_2 ?>"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="tong_luot_sd_toi_da" value="<?= $myrows->tong_luot_sd_toi_da ?>" placeholder="Nhập vào">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="luot_sd_toi_da_nguoi_mua" value="<?= $myrows->luot_sd_toi_da_nguoi_mua ?>" placeholder="Nhập vào">
...
<input type="hidden" id="checkkey" value="<?= $myrows->kieu_voucher ?>">
...
<script>
    $(document).ready(function () {
        ...
        var statuskieuapdung=<?php echo $myrows->kieu_voucher ?>,statusmucgiamtoida=<?php echo $myrows->muc_giam_toi_da ?>; // statuskieuapdung,1: Áp dụng cho sản phẩm, 2: Áp dụng cho thành viên
