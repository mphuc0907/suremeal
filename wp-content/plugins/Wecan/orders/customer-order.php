...
$module_pathadd = 'admin.php?page=customer_orders_manager';
$module_short_url = str_replace('admin.php?page=', '', $module_pathadd);
$mess = '';
$mdlconf = array('title' => 'Customer Orders');
...
$pagesize = 20;
$s = '';
$my_str = "WHERE 1=1 AND id_dealer = 0";
...
<div class="wrap">
    ...
    <?php
    $myrows = $wpdb->get_results("SELECT * FROM wp_orders ". $my_str ." AND id_dealer = 0 ORDER BY id DESC LIMIT  " . $beginpaging[0] . ",$pagesize");
    ?>
    <!--    --><?php // if ( $mess != '' ) { ?>
