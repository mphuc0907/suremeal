...
if(isset($_POST['ajax_action']) && $_POST['ajax_action'] == 'add_dealer') {
    ...
    if(!empty($errors)) {
        ...
        $result = $wpdb->insert('wp_dealer', $dealer_data);
...
<div class="wrap">
    ...
    <h1 style="margin-bottom:15px;">Add new <?php echo $mdlconf['title']; ?>
                        ...
                        <div class="inside">
                            <table class="form-table ft_metabox leftform">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="validate-input" id="dealer_name" name="dealer_name" value="" size="50" placeholder="Enter">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="validate-input" id="phone" name="phone" value="" size="50" placeholder="Enter">
                                    ...
                                    <td>
                                        <div class="date-time">
                                            <div class="time-start">
                                                <input type="time" id="open_at" name="open_at" value="">
                                            </div>
                                            <div class="time-space">-</div>
                                            <div class="time-end">
                                                <input type="time" id="close_at" name="close_at" value="">
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="text" class="validate-input" id="address" name="address" value="" placeholder="Enter">
                                            <label id="address-error" class="error d-none" for="address">This field cannot be empty</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <textarea class="validate-input" name="map" id="map" placeholder="Enter" rows="5"></textarea>
                                            <label id="map-error" class="error d-none" for="map">This field cannot be empty</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="text" class="validate-input" id="zip_code" name="zip_code" value="" placeholder="Enter">
                                            <label id="zip_code-error" class="error d-none" for="zip_code">This field cannot be empty</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        Kinh độ <span class="red-validate">*</span>
                                    </td>
                                    <td>
                                        <div class="">
                                            <input type="text" class="validate-input" id="longitude" name="longitude" value="" placeholder="Enter">
                                            <label id="longitude-error" class="error d-none" for="longitude">This field cannot be empty</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        Vĩ độ <span class="red-validate">*</span>
                                    </td>
                                    <td>
                                        <div class="">
                                            <input type="text" class="validate-input" id="latitude" name="latitude" value="" placeholder="Enter">
                                            <label id="latitude-error" class="error d-none" for="latitude">This field cannot be empty</label>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <div id="submitpost" class="submitbox">
                                    <div id="major-publishing-actions">
                                        <div id="publishing-action">
                                            <input type="submit" value="Add" id="publish" class="button button-primary button-large">
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('adddform').addEventListener('submit', function (e) {
        e.preventDefault();
        ...
        formData.append('action', 'add_dealer'); // WordPress AJAX action key
        formData.append('ajax_action', 'add_dealer');
