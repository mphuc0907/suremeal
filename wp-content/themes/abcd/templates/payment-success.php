...
// Đảm bảo rằng bạn đã cài đặt Stripe SDK
...
//try {
//    // Truy vấn thông tin từ Session ID
//    $session = \Stripe\Checkout\Session::retrieve($sessionId);
//
//    // Lấy Payment Intent ID từ Session
//    $paymentIntentId = $session->payment_intent;
//
//    // Truy vấn thông tin chi tiết thanh toán
...
//
//        // In thông tin thẻ
//        $brand = $cardDetails->brand . PHP_EOL;
//        $last4 = $cardDetails->last4 . PHP_EOL;
//        $exp_month = $cardDetails->exp_month . PHP_EOL;
//        $exp_year = $cardDetails->exp_year . PHP_EOL;
//    }
//} catch (\Exception $e) {
            ...
            <div class="w-full flex flex-col gap-6">
                <div class="w-full flex flex-col items-center justify-center gap-10 p-6 lg:p-10 bg-white rounded-xl">
                    ...
                    <div class="w-full max-w-[884px] flex flex-col gap-4 items-center">
                        <h2 class="text-heading-h4 text-[#191c1f] text-center"><?= get_field('title', get_the_ID()) ?></h2>
                        <p class="text-body-md-regular text-gray-7 text-justify lg:text-center"><?= get_field('desc', get_the_ID()) ?></p>
                    </div>
                ...
                <div class="w-full flex flex-col items-center justify-center bg-white rounded-xl">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <button class="button bg-trans" onclick="myFunction('myInput<?= $code ?>')">
                    ...
                    <div class="w-full py-6 px-8 flex flex-col gap-3 border-b border-solid border-neutral-200">
                        ...
                        ?>
                            <div
                                ...
                                <div class="flex lg:flex-0 w-full md:w-2/3 max-w-[454px] items-center gap-5">
                                    <figure
                                        class="w-[60px] h-[60px] md:w-[100px] md:h-[100px] rounded-xl border border-solid border-neutral-200 overflow-hidden">
                        ...
                        <div class="flex items-center justify-between">
                            <a href="<?= home_url() ?>/order-detail/?order_code=<?= $code ?>" class="button bg-trans text-body-md-semibold text-secondary">
                    ...
                    <div class="w-full flex flex-col lg:flex-row gap-6 py-4 px-8">
                        ...
                        <div class="w-full flex flex-col gap-4">
                            ...
                            <div class="flex items-center gap-3">
                                <figure class="w-[46px] h-[32px]"><img style="border-radius: 10px" src="https://images.viblo.asia/707a0985-4392-49ae-bab8-0648d6a9d868.png"
                                        alt="visa"></figure>
