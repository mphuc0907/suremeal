<?php /* Template Name: Dealer-Affiliate-Order */ ?>
<?php
    ...
    <div class="flex items-start col-span-1 2xl:col-span-1 xl:col-span-1 md:col-span-2 grid bg-white md:h-screen height-full">
            <ul class="list-none pl-0 text-left mt-0 memubar" x-data="{ top: false }">
                ...
                <?php if($type == 2): ?>
                    ...
                    <a class="flex items-center no-underline menu-item" href="<?= home_url() ?>/dealer-affiliate-order"><img class="mr-3 w-6 active" src="<?= $url ?>/assets/dealer/img/tabler_shopping-bag-discount_ac.png" alt=""><span class="menu-item">Affiliate orders</span></a>
                    </li>
        ...
        <div class="col-span-6 text-center py-6 px-4">
            ...
            <div class="mx-auto relative overflow-hidden bg-white rounded-xl md:w-11/12">
                    <div class="relative">
                                        ...
                                        <div class="mt-6 [--gutter:theme(spacing.6)] sm:[--gutter:theme(spacing.8)] lg:[--gutter:theme(spacing.12)] -mx-[--gutter] overflow-x-auto whitespace-nowrap">
                                            <div class="inline-block m-w-1518-full align-middle sm:px-[--gutter]">
                                                ...
                                                <div class="grid grid-cols-7 bd-line-bottom">
                                                        ...
                                                        <div class="col-span-1 px-10 py-5 text-base text-right">$5460.00</div>
                                                        <div class="col-span-1 px-10 py-5 text-base text-right">$5460.00 </div>
                                                        <div class="col-span-1 px-10 py-5 text-base text-center"><a href="affiliate-order-detail.html" class="flex items-center no-underline"><span class="text-base font-semibold blue-sure">View detail</span><img class="ml-2 w-6" src="<?= $url ?>/assets/dealer/img/arrowright_tb.png" alt=""></a></div>
                                                </div>
                                                <div class="grid grid-cols-7 bd-line-bottom">
                                                        <div class="col-span-1 px-10 py-5 text-base text-left">#123ABCXYZ</div>
                                                        <div class="col-span-1 px-10 py-5 text-base text-left">11/05/2023 - 7:05 PM</div>
                        ...
                        <img src="<?= $url ?>/assets/dealer/img/caretleft.png" alt="">
                        </a>
                        ...
                        <img src="<?= $url ?>/assets/dealer/img/caretright.png" alt="">
                        </a>
                    </div>
                    </div>
            </div>
