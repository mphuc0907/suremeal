...
<main class="bg-[#EEF0F6]">
    <section class="pt-6 pb-10">
        <div class="container">
            ...
            <h1 class="text-heading-h2 tex-gray-9">Search result : <?= $search_query ?></h1>
        </div>
    </section>
    ...
    <section class="pb-10 lg:pb-20">
        <div class="container">
            <div class="flex flex-wrap items-center justify-between gap-6">
                <h2 class="text-heading-h3-5 text-gray-8">Product list </h2>
            </div>
            <!-- vỉew -->
                    ...
                    <div class="img-hover bg-white rounded-3xl overflow-hidden">
                        ...
                        <div class="flex flex-col gap-3 px-6 pb-[20px] mt-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <p class="text-body-sm-regular text-neutral-500"><?= countReview($value->ID) ?> Reviews</p>
                            </div>
    ...
    <section class="pb-10 lg:pb-20">
        <div class="container">
            <div class="flex flex-wrap items-center justify-between gap-6">
                <h2 class="text-heading-h3-5 text-gray-8">Blog list</h2>
            </div>
            <!-- vỉew -->
                        ...
                        <div class="img-hover bg-white rounded-xl overflow-hidden flex flex-col gap-3">
                            <a href="<?php the_permalink(); ?>">
                                <div class="image overflow-hidden" style="aspect-ratio: 44/26">
                                    <figure class="figure-44-26 xl:max-h-[260px]">
                            ...
                            <div class="p-5 flex flex-col gap-3">
                                ...
                                <a href="<?php the_permalink(); ?>" class="text-body-md-semibold text-primary">Read
                                    more</a>
                            </div>
                        </div>
                    <?php endwhile ?>
