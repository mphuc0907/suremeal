...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $user = $wpdb->get_row(
            $wpdb->prepare("SELECT * FROM $table WHERE email = %s AND type = 1", $email)
        );
            ...
            <div class="w-full max-w-[667px] mx-auto rounded-2xl border border-solid border-neutral-200 bg-white">
                <div class="p-8 flex flex-col gap-8">
                    <div class="flex gap-6 items-center">
                        ...
                        <a href="<?= home_url() ?>/sign-up" class="sign-tab">Sign up</a>
                    </div>
                        ...
                        <form id="signInForm" class="w-full">
                            <div class="flex flex-wrap gap-4">
                                ...
                                <div class="w-full flex justify-end">
                                    <a href="<?= home_url() ?>/reset-password" class="text-body-md-regular text-secondary"><?php pll_e('Forgot password?') ?></a>
                                </div>
                                <div class="w-full">
