...
<div class="relative">
        <div class="grid 2xl:grid-cols-7 xl:grid-cols-7 md:grid-cols-8 sm:grid-cols-1 grid-cols-1 gap-0">
            <div class="flex items-start col-span-1 2xl:col-span-1 xl:col-span-1 md:col-span-2 grid bg-white md:height-full h-auto">
                <ul class="list-none pl-0 text-left mt-0 memubar" x-data="{ top: false }">
                    <li class="flex items-center pt-4 pb-4 pl-6 item-f dashboard checkout-menu-active">
                        <a class="flex items-center no-underline" href="doashboard.html"><img class="mr-3 w-6 default hidden" src="img/cuida.png" alt=""><img class="mr-3 w-6 active" src="img/cuida_ac.png" alt=""><span class="menu-item">Dashboard</span></a>
                    </li>
                ...
                <div class="mx-auto relative md:w-11/12 w-full bg-white md:y-6 md:px-10 p-4 rounded-xl mb-8">
                    ...
                    <div class="grid lg:grid-cols-12 gap-8 static">
                        <div class="flex items-start col-span-4">
                            <div class="image mr-4"><img class="w-24 h-auto" src="img/statis-1.png" alt=""></div>
                            <div class="text-left">
                        ...
                        <div class="flex items-start col-span-4">
                            <div class="image mr-4"><img class="w-24 h-auto" src="img/statis-2.png" alt=""></div>
                            <div class="text-left">
                        ...
                        <div class="flex items-start col-span-4">
                            <div class="image mr-4"><img class="w-24 h-auto" src="img/statis-3.png" alt=""></div>
                            <div class="text-left">
                                ...
                                <div class="grid grid-cols-12 mb-10">
                                    <div class="md:col-span-6 col-span-12 flex items-center text-left">
                                        <ul class="list-none flex pl-0 m-0">
                                            <li class="flex items-center mr-10"><img class="w-4 mr-2" src="img/e1.png" alt=""><span class="chart-font-size">Revenue</span></li>
                                            <li class="flex items-center"><img class="w-4 mr-2" src="img/e2.png" alt=""><span>Order</span></li>
                                        </ul>
