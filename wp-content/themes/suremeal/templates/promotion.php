            ...
            <div class="p-8 flex flex-col items-center tab-promotion active" data-tabPromotion="onSale">
                <div class="p-2 rounded-full md:bg-neutral-100 flex flex-col md:flex-row gap-4">
                    ...
                    <div class="countdown-contain bg-neutral-100 md:bg-none py-2 px-6 rounded-full flex items-center gap-4">
                        <span class="min-h-[34px] flex items-center text-heading-h7 text-neutral-500"><?php pll_e('Tomorrow') ?> 00:00 - 07:59</span>
                    </div>
                </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="flex gap-2 items-center">
                                                    ...
                                                    <div class="flex rounded-full items-center"
                                                        ...
                                                        <span
                                                            class="block text-[#E4626F] font-bold text-[14px] pr-3">-70%</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <button
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tabPromotionItems.forEach(item => {
            item.addEventListener('click', function() {
                ...
                tabPromotionItems.forEach(tab => tab.classListNaNpxove('active'));
                tabContents.forEach(content => content.classListNaNpxove('active'));
                tabPromotions.forEach(promotion => promotion.classListNaNpxove('active'));
