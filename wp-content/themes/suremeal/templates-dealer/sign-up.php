...
<div class="relative min-h-screen overflow-hidden bg-gray-50 py-16 sm:py-12 signup text-center px-4">
    <div class="mx-auto items-center mb-16">
        <a href="index.html"><img src="<?= $url ?>/assets/dealer/<?= $url ?>/assets/dealer/img/logo.png" class="w-64" alt="" /></a>
    </div>
    <div class="mx-auto relative p-8 rounded-2xl bg-white w-1360-full overflow-hidden border-cm">
        ...
        <form id="signUpForm" class="w-full" method="post">
            <div class="md:visible md:flex sm:block">
                ...
                <div class="flex-none lg:w-32 md:w-32 text-center hidden md:block">
        ...
        <p class="text-base font-medium mb-4 py-0">Or connect with:</p>
        <div class="flex justify-center">
            <ul class="list-none p-0 mb-0 text-center">
                <li class="border-solid border border-gray-300 w-400 justify-center p-2 box-border mb-3 rounded-lg">
                    <a href="" class="text-base no-underline"><img class="m-b5" src="<?= $url ?>/assets/dealer/img/gg-icon.svg" alt=""><span class="ml-3 text-color-sure font-inter">Continue with Google</span></a>
                </li>
                <li class="border-solid border border-gray-300 w-400 justify-center p-2 box-border mb-3 rounded-lg">
                    <a href="#" id="fb-login" class="text-base no-underline"><img class="m-b5" src="<?= $url ?>/assets/dealer/img/fb-icon.svg" alt=""><span class="ml-3 text-color-sure font-inter">Continue with Facebook</span></a>
                </li>
                <li class="border-solid border border-gray-300 w-400 justify-center p-2 box-border mb-0 rounded-lg">
                    <a href="" class="text-base no-underline"><img class="m-b5" src="<?= $url ?>/assets/dealer/img/apple-icon.svg" alt=""><span class="ml-3 text-color-sure font-inter">Continue with Apple</span></a>
                </li>
            </ul>
        </div>
    </div>
