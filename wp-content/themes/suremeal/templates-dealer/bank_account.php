<?php /* Template Name: Bank account information */ ?>
<?php
                ...
                <div class="grid md:gap-10 gap-4 md:grid-cols-2 grid-cols-1 mb-6">
                    <div class="text-left">
                        ...
                        <?php if (isset($errors['bank_name'])): ?>
                            <p class="validation-error text-justify text-red-500 text-sm mt-1"><?= $errors['bank_name'] ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="text-left">
                        ...
                        <?php if (isset($errors['account_number'])): ?>
                            <p class="validation-error text-justify text-red-500 text-sm mt-1"><?= $errors['account_number'] ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="grid md:gap-10 gap-4 md:grid-cols-2 grid-cols-1 mb-6">
                    <div class="text-left">
                        ...
                        <?php if (isset($errors['routing_number'])): ?>
                            <p class="validation-error text-justify text-red-500 text-sm mt-1"><?= $errors['routing_number'] ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="text-left">
                        ...
                        <?php if (isset($errors['holder_name'])): ?>
                            <p class="validation-error text-justify text-red-500 text-sm mt-1"><?= $errors['holder_name'] ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="grid md:gap-10 gap-4 md:grid-cols-2 grid-cols-1 mb-6">
                    <div class="text-left">
                        ...
                        <?php if (isset($errors['swift'])): ?>
                            <p class="validation-error text-justify text-red-500 text-sm mt-1"><?= $errors['swift'] ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="text-left">
                        ...
                        <?php if (isset($errors['iban'])): ?>
                            <p class="validation-error text-justify text-red-500 text-sm mt-1"><?= $errors['iban'] ?></p>
                        <?php endif; ?>
                    </div>
                </div>
