...
<div class="relative min-h-screen overflow-hidden bg-gray-50 py-16 sm:py-12 py-4 signin text-center">
    <div class="mx-auto items-center mb-16">
        <a href="index.html"><img src="<?= $url ?>/assets/dealer/img/logo.png" class="w-64" alt="" /></a>
    </div>
    <div class="px-4">
        <div class="mx-auto relative p-8 rounded-2xl bg-white w-668-full overflow-hidden border-cm">
            ...
            <ul class="list-none p-0 mb-0">
                <li class="border-solid border border-gray-300 w-full justify-center p-2 box-border mb-3 rounded-lg">
                ...
                <li class="border-solid border border-gray-300 w-full justify-center p-2 box-border mb-3 rounded-lg">
                    <a href="" class="text-base no-underline"><img class="m-b5" src="<?= $url ?>/assets/dealer/img/fb-icon.svg" alt=""><span class="ml-3 text-color-sure font-inter">Continue with Facebook</span></a>
                </li>
                <li class="border-solid border border-gray-300 w-full justify-center p-2 box-border mb-0 rounded-lg">
