    ...
    <section>
        <div class="container">
            <div class="p-6 lg:p-10 rounded-xl bg-white flex flex-wrap gap-8 lg:gap-12">
                <div data-aos="fade-right" data-aos-duration="1500" class="w-full lg:w-1/2 xl:max-w-[553px] flex flex-col gap-4">
                    <div class="hidden md:block slider-galeria swiper">
                    ...
                    <div class="relative swiper-wrap">
                ...
                <div data-aos="fade-left" data-aos-duration="1500" class="flex-1 flex flex-col gap-6">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <?php if (empty($sale_price)) : ?>
                                    <h2 class="text-heading-h3-5 text-gray-8" data-price="<?= $price ?>">
                                        <?= formatBalance($price) ?></h2>
                                    <!--                                <div class="flex items-center gap-1">-->
                                    <!--                                    <p class="line-through text-body-md-regular text-gray-7">$120.00 </p>-->
                                    <!--                                    <span class="text-body-md-medium text-primary">30%</span>-->
                                    <!--                                </div>-->
                                <?php else: ?>
                                    <h2 class="text-heading-h3-5 text-gray-8" data-price="<?= $sale_price ?>">
                                        <?= formatBalance($sale_price) ?></h2>
                                    <div class="flex items-center gap-1">
                                        <p class="line-through text-body-md-regular text-gray-7">
                                            <?= formatBalance($price) ?></p>
                                        <span
                                            class="text-body-md-medium text-primary"><?= number_format($percentDecrease, 2) ?>%</span>
                                    </div>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-3">
                        <button
                            ...
                            data-id="<?= $post_id ?>" data-link="<?php echo get_permalink($post_id) ?>"
                            data-img="<?php echo checkImage($post_id) ?>"
                            data-price="<?php echo !empty($sale_price) ? $sale_price : $price; ?>"
                            data-title="<?= $title ?>" data-instock="<?= $instock ?>"
